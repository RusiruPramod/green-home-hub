      ...
      <main className="flex-1 overflow-auto">
        <header className="sticky top-0 z-10 flex h-14 sm:h-16 md:h-16 lg:h-20 items-center justify-between border-b border-border bg-background/80 px-3 sm:px-6 md:px-8 lg:px-10 backdrop-blur-lg">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-foreground">API Services</h1>
              <p className="text-xs sm:text-sm md:text-base text-muted-foreground hidden sm:block">
                Manage and monitor your Green Home Hub API endpoints
              </p>
            </div>
          </div>
          <div>
            <Button onClick={checkApiStatus} variant="outline" size="sm" className="text-xs sm:text-sm">
              Refresh Status
            </Button>
          </div>
        </header>

        <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6 md:space-y-8 p-3 sm:p-6 md:p-8 lg:p-10">
